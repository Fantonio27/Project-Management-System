...
--
-- Host: 127.0.0.1
-- Generation Time: May 04, 2023 at 04:50 AM
...
INSERT INTO `course_information` (`CID`, `FIELD`, `ACRONYM`, `COURSE_NAME`, `INFORMATION`, `HEADER_PICTURE`, `IAQID`, `DATE_CREATED`, `DATE_UPDATED`) VALUES
...
('ERID_1', 3, 0, 4, 3, 10, 'Failed', '123456789012', '2023-05-04'),
('ERID_2', 1, 0, 3, 3, 7, 'Failed', '123123123123', '2023-05-04');
...
--
ALTER TABLE `save_answer`
  MODIFY `SAID` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3363;
