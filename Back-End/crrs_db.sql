...
('CID_15', 'Social Science', 'AB Anthropology', 'Bachelor of Arts in Anthropology', 'The Bachelor of Arts in Anthropology (AB Anthropology) is a four-year degree program in the Philippines that will teach you about the origin and evolution of human beings including gradual changes in their genetic makeup, behavior, languages, and social relations. ', 'AB ANTHROPOLOGY.jpg', 'IAQID_17', '04/17/23'),
('CID_16', 'Social Science', 'AB Sociology', 'Bachelor of Arts in Sociology', 'The Bachelor of Arts in Sociology (AB Sociology) is a four-year degree program in the Philippines that will teach you about human society, its structure, history, development, and how different cultural groups vary from one to another. ', 'AB SOCIOLOGY.jpg', 'IAQID_17', '04/17/23'),
...
('CID_18', 'Social Science', 'BSFS', 'Bachelor of Science in Forensic Science', 'The Bachelor of Forensic Science is a four-year degree program in the Philippines that will train you in using scientific principles and techniques to solve different crimes.', 'BSFS FORENSIC SCIENCE.jpg', 'IAQID_15', '04/17/23'),
...
('CID_33', 'Formal Sciences', 'BS Stat', 'Bachelor of Science in Statistics', 'The Bachelor of Science in Statistics (BS Statistics) is a four-year degree program in the Philippines that will teach you about different statistical methods and how to use them to analyze and interpret data. ', 'BS STAT.jpg', 'IAQID_24', '04/17/23'),
...
('CID_4', 'Humanities', 'BFA Industrial Design', 'Bachelor of Fine Arts Major in Industrial Design', 'is a four-year degree program in the Philippines that is primarily concerned with the design and development of usable products as well as the designing packaging and systems. ', 'BFA INDUSTRIAL DESGIN.jpg', 'IAQID_14', '04/17/23'),
...
('CID_56', 'Health Sciences', 'BS Pharmacy', 'Bachelor of Science in Pharmacy', '', 'BS PHARMACIST.jpg', 'IAQID_42', '04/17/23'),
...
('CID_60', 'Education', 'BSED', 'Bachelor in Secondary Education', 'The Bachelor of Secondary Education (BSEd) is a four-year degree program in the Philippines that will prepare you in teaching in secondary school. It has several areas of specialization: English, Filipino, Islamic Studies, Mathematics, Music, Arts, Physic', 'BSED SECONDARY EDUCATION.jpg', 'IAQID_30', '04/17/23'),
('CID_61', 'Education', 'BEED', 'Bachelor in Elementary Education', 'The Bachelor of Elementary Education (BEED) is a four-year degree program in the Philippines that will train you in teaching grade school students. BEED has two specializations: Bachelor in Elementary Education Major in Preschool Education and Bachelor in', 'BEED ELEMENTARY EDUCATION.jpg', 'IAQID_29', '04/17/23'),
...
('CID_63', 'Engineering', 'BPE', 'Bachelor of Physical Education', 'The Bachelor of Physical Education is a four-year degree program in the Philippines that will train you in developing and maintaining the optimal physical fitness and functionality individuals. It has two majors: School Physical Education which is a teach', 'BPE PHYSICAL EDUCATION.jpg', 'IAQID_31', '04/17/23'),
...
('CID_69', 'Media and Communication', 'AB Broadcasting', 'Bachelor of Arts in Broadcasting', 'The Bachelor of Arts in Broadcasting (AB Broadcasting) is a four-year degree program in the Philippines that will prepare you for a career in the media industry, particularly in television and radio networks. Being a subfield of Class Communication, AB Br', 'AB BROADCASTING.jpg', 'IAQID_48', '04/17/23'),
...
('CID_70', 'Media and Communication', 'AB Communication', 'Bachelor of Arts in Communication', 'The Bachelor of Arts in Communication (AB Communication) is a four-year degree program in the Philippines that will prepare you for a career in the media or similar industries — advertising agencies and public relations firms in particular ', 'AB COMMUNICATION.jpg', 'IAQID_48', '04/17/23'),
...
('CID_89', 'Media and Communication', 'AB MassComm', 'Bachelor of Arts in Mass Communication', 'is a four-year degree program in the Philippines that will train you in the effective use of different media in order to send out specific messages to targeted audiences.', 'mas comm.jpg', 'IAQID_48', '04/30/23'),
...
('CID_94', 'Public Administration', 'BSPS', 'Bachelor of Science in Public Safety ', 'is a four-year degree program in the Philippines that will help you acquire knowledge and skills essential to ensuring public safety', 'pub safe.jpg', 'IAQID_37', '04/30/23'),
...
('ERID_0', 2, 2, 4, 2, 10, 'Failed', '123123123123', '2023-05-02');
...
INSERT INTO `ia_result` (`IAR`, `DEPARTMENT`, `ANSWER`, `INTEREST`, `IAQID`, `LRN`, `DATE`) VALUES
('IAR_0', 'Formal Sciences', 'If you like working with numbers, logic, and patterns, and enjoy using math to solve problems and analyze data.', '', 'IAQID_24', '123123123123', '2023-05-02');
...
('RID_0', 'ERID_0', 'IAQID_24', 'Bachelor of Science in Mathematics', '123123123123', '2023-05-02');
...
(3243, 'Math', '0.80	', '1.00', 'EQMID_10', '123123123123'),
(3244, 'Math', '0.60', '0.64', 'EQMID_11', '123123123123'),
(3245, 'Math', '0.74', '0.80', 'EQMID_12', '123123123123'),
(3246, 'Math', '0.60', '0.60', 'EQMID_13', '123123123123'),
(3247, 'Math', '0.27', '0.39', 'EQMID_16', '123123123123'),
(3248, 'Math', 'V-shaped', 'Bell-shaped', 'EQMID_18', '123123123123'),
(3249, 'Math', '0.9876', '0.6879', 'EQMID_17', '123123123123'),
(3250, 'Math', '4.0', '4.0', 'EQMID_14', '123123123123'),
(3251, 'Math', '4.15', '8.00', 'EQMID_15', '123123123123'),
(3252, 'Math', '100 sq. unit', '1 sq. unit', 'EQMID_19', '123123123123'),
(3253, 'Science', 'Red Giant', 'White Dwarf', 'EQSID_10', '123123123123'),
(3254, 'Science', 'Symmetrical', 'Symmetrical', 'EQSID_18', '123123123123'),
(3255, 'Science', 'Star Formation Theory', 'Star Formation Theory', 'EQSID_1', '123123123123'),
(3256, 'Science', 'Henry Mosely', 'Henry Mosely', 'EQSID_12', '123123123123'),
(3257, 'Science', 'Protostar', 'Supernova ', 'EQSID_11', '123123123123'),
(3258, 'Science', 'Fusion', 'Alpha Emission', 'EQSID_13', '123123123123'),
(3259, 'Science', 'It is a Polar Molecule', 'It is a Polar Molecule', 'EQSID_16', '123123123123'),
(3260, 'Science', 'Alpha Emission', 'Beta Emission', 'EQSID_14', '123123123123'),
(3261, 'Science', 'All of the above', 'Non-Polar', 'EQSID_17', '123123123123'),
(3262, 'Science', 'Beta Emission', 'Gamma Emission', 'EQSID_15', '123123123123'),
(3263, 'English', 'Use of Language', 'Physical Setting', 'EQEID_10', '123123123123'),
(3264, 'English', 'Caution', 'Caution', 'EQEID_1', '123123123123'),
(3265, 'English', 'Proposal Paper', 'Technical Report', 'EQEID_12', '123123123123'),
(3266, 'English', 'Periodic Report', 'Progress Report', 'EQEID_13', '123123123123'),
(3267, 'English', 'Abstract', 'Exact', 'EQEID_14', '123123123123'),
(3268, 'English', 'Concept Paper	', 'Concept Paper	', 'EQEID_11', '123123123123'),
(3269, 'English', 'Rough Drafting', 'Collecting Data', 'EQEID_16', '123123123123'),
(3270, 'English', 'Writing that takes a short time to read.', 'Writing that requires a reader to gather additional information to comprehend the content.', 'EQEID_15', '123123123123'),
(3271, 'English', 'Exposition of the strongest argument or claim.', 'Identification of the debatable issue.', 'EQEID_17', '123123123123'),
(3272, 'English', 'Examine all the claims of the author and find loopholes or flaws in the light of logical explanations.', 'Go through the article and refute each of the main points, explaining how stupid the author’s views are.', 'EQEID_18', '123123123123'),
(3273, 'Reading_Comprehension', 'New Literature', '21ST Century Literature', 'EQRCID_10', '123123123123'),
(3274, 'Reading_Comprehension', 'Text Talk Novel', 'Blogs', 'EQRCID_16', '123123123123'),
(3275, 'Reading_Comprehension', '', 'Science Fiction', 'EQRCID_18', '123123123123'),
(3276, 'Reading_Comprehension', 'Blogs', 'Chick Literature', 'EQRCID_17', '123123123123'),
(3277, 'Reading_Comprehension', 'Pre-colonial Literature', 'Pre-colonial Literature', 'EQRCID_1', '123123123123'),
(3278, 'Reading_Comprehension', 'Graphic Novel', 'Illustrated Novel', 'EQRCID_11', '123123123123'),
(3279, 'Reading_Comprehension', 'Graphic Novel', 'Graphic Novel', 'EQRCID_13', '123123123123'),
(3280, 'Reading_Comprehension', 'Chick Lit', 'Digi-Fiction', 'EQRCID_12', '123123123123'),
(3281, 'Reading_Comprehension', 'Chick Literature', 'Manga', 'EQRCID_15', '123123123123'),
(3282, 'Reading_Comprehension', 'Manga', 'Doodle Fiction', 'EQRCID_14', '123123123123');
...
--
ALTER TABLE `save_answer`
  MODIFY `SAID` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3283;
