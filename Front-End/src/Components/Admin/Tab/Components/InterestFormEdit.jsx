            ...
            <div>
                <div className="CI_Form_Title">
                    <div>
                        ...
                        <p className="CI_Form_subTitle">Edit a question for Interest assessment</p>
                    </div>
                </div>
                <div className="insterest_assesement">
                    ...
                    <button className="button_save" style={{ width: "max-content", marginTop: '20px' }} onClick={handleSubmit}>Update</button>
                </div>
            </div>
        </Fade>
    )
