...
export default function Course_Information() {
    ...
    const deleterecord = () => {
        setOpendelete(false);
        axios.delete(`http://localhost/recommendation_system/api/admin/IA_QUESTIONS.php?id="${id}"`).then(function (response) {
    ...
    const column = [
        { id: 'IAQID', label: 'IAQID', align: 'center', minWidth: 50 },
        { id: 'QUESTION', label: 'Question', minWidth: 100 },
        { id: 'HIP', label: 'Acronym', minWidth: 100 },
        { id: 'ACTION', label: 'Actions', align: 'center', minWidth: 50 },
    ]

    const text = (
        <div style={{ width: "100%", display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <p className="titlepertable">Interest Assessment</p>
    ...
    React.useEffect(() => {
        axios.get(`http://localhost/recommendation_system/api/admin/IA_Questions.php?FETCH='ALL'`).then(function (response) {
